...
contains
  ...
  subroutine InitAllocate(this, bounds, lbj, ubj, betrtracer_vars)
    ...
    !Jing Tao added temporarily for ReSOM
    SPVAL_ALLOC(this%tracer_flx_decomp_vr_col  (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_uptake_vr_col  (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_cue_vr_col     (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_maint_vr_col   (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_kaffmm_vr_col  (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_kaffem_vr_col  (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_micgrow_vr_col (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_enzprod_vr_col (begc:endc, lbj:ubj,1))
    SPVAL_ALLOC(this%tracer_flx_turnover_vr_col(begc:endc, lbj:ubj,1))
