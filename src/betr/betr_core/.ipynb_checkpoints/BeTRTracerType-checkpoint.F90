...
#include "bshr_assert.h"
  ...
  type, public :: BeTRtracer_type
   ...
   real(r8), pointer :: move_scalar(:)    => null() !Jing Tao added back, temporarily for ReSOM
...
!--------------------------------------------------------------------------------
  ...
  allocate(this%move_scalar        (this%ntracer_groups));      this%move_scalar(:)     = 1._r8 !Jing Tao added back temporarily for ReSOM
