...
implicit none
 ...
 type, public, extends(BiogeoCon_type) :: resomPara_type
  ...
  ! Microbial parameters
    ...
    !logical :: use_warm          !added for consistency with BgcresomDecompType.F90    ! already declared in soil-farm/bgcfarm_util/BiogeoConType.F90   -zlyu
 ...
 end type resomPara_type

 type(resomPara_type), public :: resom_para
...
contains
  ...
  ! constructor
    implicit none
    class(resomPara_type), pointer :: create_jarpars_resomeca
    class(resomPara_type), pointer :: bgc
  ...
  implicit none
  class(resomPara_type), intent(inout) :: this
