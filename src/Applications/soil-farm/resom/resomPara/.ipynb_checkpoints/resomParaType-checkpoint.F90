...
implicit none
 ...
 type, public, extends(BiogeoCon_type) :: resom_para_type
  ...
  ! Microbial parameters
    ...
    real(r8) :: ref_kaff_mono_msurf_sc
    ...
    !logical :: use_warm          !added for consistency with resomBGCDecompType.F90    ! already declared in soil-farm/bgcfarm_util/BiogeoConType.F90   -zlyu
 ...
 contains
   procedure, public  :: Init => resompara_init
   procedure, public  :: readPars => resompara_readPars
   procedure, public  :: printPars=> resompara_printPars
   procedure, private :: InitAllocate
   procedure, private :: set_defpar_default
   procedure, public  :: apply_spinup_factor
   procedure, public  :: set_spinup_factor
 end type resom_para_type

 type(resom_para_type), public :: resom_para
 public :: create_jarpars_resomeca
contains

  function create_jarpars_resomeca()
  ! DESCRIPTION
  ! constructor
    implicit none
    class(resom_para_type), pointer :: create_jarpars_resomeca
    class(resom_para_type), pointer :: bgc

    allocate(bgc)
    create_jarpars_resomeca => bgc

  end function create_jarpars_resomeca

  !--------------------------------------------------------------------
  subroutine resompara_init(this, bstatus)
  !subroutine resompara_init(this, namelist_buffer, bstatus)
  ...
  implicit none
  class(resom_para_type), intent(inout) :: this
  ...
  ! Set up parameters for activation energy of different processes
    ...
    this%ea_kaff_enz_poly       = 15000._r8/rgas      ! Ea for polymer-enzyme affinity (K)
  ...
  this%k_decay_cwd           = 6.5_r8/year_sec                 !1/second
...
! need update for resom pools
  ...
  subroutine resompara_readPars(this, ncid, bstatus)
  ...
  end subroutine resompara_readPars
...
!--------------------------------------------------------------------
  subroutine resompara_printPars(this)
  ...
  end subroutine resompara_printPars

end module resomParaType
